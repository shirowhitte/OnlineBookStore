	   ...
	   <h2>View Transaction History</h2>
		...
		try
		{
			...
			while(p.getResultSet().next())
			{
				...
				out.println("<td>"+p.getResultSet().getInt(2)+"</td>");
				out.println("<td>"+p.getResultSet().getString(3)+"</td>");
				out.println("<td>"+p.getResultSet().getString(4)+"</td>");
				out.println("<td>"+p.getResultSet().getInt(5)+"</td>");
				out.println("<td>"+p.getResultSet().getString(6)+"</td>");
				out.println("</tr>");
			}
		}
		catch(SQLException e)
